...
* Database Migration: It is possible to migrate ToU acceptance and attribute release consent data using the "provided data migration script":#Upgrade.databaseMigration.
...
h3(#Upgrade.databaseMigration). Database Migration
