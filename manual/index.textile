...
You might adjust/extend the "provided":examples/messages/ resource bundles and copy them in the IdPs classpath (e.g., @$IDP_INSTALL$/src/main/webapp/WEB-INF/classes/uApprove/messages@).
