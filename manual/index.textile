...
Replace the varialbe $IDP_HOME$ by the correct path, e.g. @/opt/shibboleth-idp@ (so that the whole value looks like @file:/opt/shibboleth-idp/conf/uApprove.properties@ for example).
...
h2. 3.4 Upgrade from uApprove >= 2.5
