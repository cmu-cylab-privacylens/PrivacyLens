...
* Copy the JDBC connector for your database to Shibboleth's classpath. PrivacyLens itself already provides MySQL or HSQL JDBC connectors: <br /> @cp $PLENS_DIST$/lib/jdbc/optional/#jdbc-connector#.jar $SHIB_DIST$/lib@
