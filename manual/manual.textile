...
* Copy the JDBC connector for your database to Shibboleth's classpath. PrivacyLens itself already provides "MySQL":http://mysql.com or "HSQL":http://hsqldb.org JDBC connectors:
** @cp $PLENS_DIST$/lib/jdbc/optional/#jdbc-connector#.jar $SHIB_DIST$/lib@
...
h2. 2.4 Forcing Shibboleth to honor choices

XXXstroucki add this
